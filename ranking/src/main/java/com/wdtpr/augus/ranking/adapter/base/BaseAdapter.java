...
import com.wdtpr.augus.ranking.adapter.factory.ItemTypeFactory;
import com.wdtpr.augus.ranking.adapter.listener.OnMultiItemClickListener;
...
//        LogUtils.d("viewType:"+viewType);
    ...
    public void onBindViewHolder(final BaseViewHolder holder, int position) {
        holder.bindViewData(mContext, mData.get(position), position,mData.size()-1);
        if (listener != null) {
