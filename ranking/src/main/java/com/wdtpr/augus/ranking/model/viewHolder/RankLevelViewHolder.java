...
public class RankLevelViewHolder extends BaseViewHolder {
    private ConstraintLayout cl;
    private ImageView ivCup;
    private TextView tvScore, tvName, tvSchoolName,tvRank,tvClassName;


    public RankLevelViewHolder(View itemView) {
        super(itemView);
        cl = (ConstraintLayout) getView(R.id.cl);
        tvName = (TextView) getView(R.id.tvName);
        tvClassName = (TextView) getView(R.id.tvClassName);
    ...
    public void bindViewData(Context context, Object data, int itemPosition, int finalPosition) {
        ...
        switch (bean.getType()) {
            ...
            case "nation":
                ...
                //
                tvSchoolName.setText(bean.getSub_School_Name());
                tvClassName.setText(bean.getClass_Name());
                tvName.setText(bean.getStudent_Name());
                break;
        }
