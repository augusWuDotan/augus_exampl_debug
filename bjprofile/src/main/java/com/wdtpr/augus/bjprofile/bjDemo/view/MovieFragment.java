 ...
 */
public class MovieFragment extends Fragment implements ILearnRecordContract.LearnRecordIRSStateView {
    private static final String STUDENTID = "STUDENTID_MOVIE";
    ...
    private List<MovieData> beanData;
    ...
    public static MovieFragment newInstance(int studentId) {
    ...
    private void initView(View view) {
        ...
        learnRecordPresenter.GetMovieRecord(StudentID, "");
    ...
    public void GetMovieRecordSucess(List<MovieData> bean) {
        ...
        beanData = bean;
        //this data
        mAdapter = new mPagerAdapter(getChildFragmentManager(), bean, Profile_Key.MOVIE.name());
